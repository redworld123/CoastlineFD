...
Dividers_Functoin = function (path, r, pearsonValue) {
  ...
  if (abs(pearson) >= pearsonValue) {
    ...
    warning("Dividers_Functoin: The Pearson coefficient of your input data is less than you defined!")
    return(NA)
  }
...
Boxes_Function = function (path, netPath, n, pearsonValue) {
  ...
  if (abs(pearson) >= pearsonValue) {
    ...
    warning("Boxes_Functoin: The Pearson coefficient of your input data is less than you defined!")
    return(NA)
  }
...
#' @param BinputPath    All origin shoreline files path, up to the last folder
